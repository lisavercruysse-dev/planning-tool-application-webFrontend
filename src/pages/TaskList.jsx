...
export default function TaskList() {
  ...
  const filteredTasks = useMemo(() => {
    const byDate = TASK_DATA.filter(
      (task) => toDateInputValue(new Date(task.startdatum)) === selectedDate,
    );
  ...
  return (
    <div className="mx-16 mt-8">
      <div className="flex items-center gap-3 mb-4">
        <span className="text-sm text-gray-700 font-medium">Kies datum:</span>
