...
export function TaskCards({ tasks, searchQuery, setSearchQuery, onTaskDetailsClick, onCompleted }) {
  return (
    <div className="border border-gray-200 rounded-[10px] flex flex-col w-full">
      ...
      <div className="divide-y divide-gray-200">
        {tasks.length ? (
          tasks.map((t) => <TaskCard key={t.id} {...t} onDetailsClick={() => onTaskDetailsClick(t)} onCompleted={() => onCompleted(t)}/>)
        ) : (
